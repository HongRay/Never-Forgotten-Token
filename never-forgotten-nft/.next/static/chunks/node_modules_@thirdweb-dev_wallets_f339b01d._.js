...
"[project]/node_modules/@thirdweb-dev/wallets/evm/connectors/signer/dist/thirdweb-dev-wallets-evm-connectors-signer.browser.esm.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "SignerConnector": (()=>SignerConnector)
});
...
;
;
class SignerConnector extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$connector$2d$05689d68$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["C"] {
    constructor(options){
        super();
    ...
    async getProvider() {
        if (!this._provider) {
            this._provider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$index$2d$33cd3415$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__a___as__getChainProvider$3e$__["getChainProvider"])(this.options.chain, {
    ...
    async switchChain(chainId) {
        ...
        this._provider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$index$2d$33cd3415$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__a___as__getChainProvider$3e$__["getChainProvider"])(chain, {
            clientId: this.options.clientId,
            secretKey: this.options.secretKey
        });
...
//# sourceMappingURL=node_modules_%40thirdweb-dev_wallets_f339b01d._.js.map