...
"[project]/node_modules/@blocto/sdk/dist/blocto-sdk.module.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@thirdweb-dev/wallets/evm/connectors/blocto/dist/thirdweb-dev-wallets-evm-connectors-blocto.browser.esm.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$blocto$2f$sdk$2f$dist$2f$blocto$2d$sdk$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@blocto/sdk/dist/blocto-sdk.module.js [app-client] (ecmascript)");
...
;
;
class BloctoConnector extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$WagmiConnector$2d$2f14002d$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["W"] {
    constructor(_ref){
    ...
    getProvider() {
        ...
        if (!this._provider) {
            ...
            this._provider = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$blocto$2f$sdk$2f$dist$2f$blocto$2d$sdk$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]({
                ethereum: {
                    chainId: _chainId,
                    rpc: _rpc
                },
    ...
    async switchChain(chainId) {
        ...
        if (!chain) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$errors$2d$9edc08c8$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["S"](new Error("chain not found on connector."));
        }
        ...
        if (!isBloctoSupportChain) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$errors$2d$9edc08c8$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["S"](new Error(`Blocto unsupported chain: ${id}`));
        }
        try {
            await provider.request({
                method: "wallet_addEthereumChain",
                params: [
                    {
                        chainId: id,
                        rpcUrls: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$url$2d$a45219bd$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["g"])(chain) // no client id on purpose here
                    }
                ]
            });
            await provider.request({
    ...
    async onChainChanged(chain) {
        const id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$normalizeChainId$2d$1fb9aedf$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["n"])(chain);
        const unsupported = this.isChainUnsupported(id);
...
//# sourceMappingURL=node_modules_57de1d41._.js.map