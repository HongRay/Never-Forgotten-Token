...
"[project]/node_modules/thirdweb/dist/esm/utils/caching/lru.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/utils/text-encoder.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/utils/encoding/helpers/is-hex.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/utils/encoding/helpers/assert-size.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function assertSize(hexOrBytes, { size }) {
    const givenSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$helpers$2f$byte$2d$size$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["byteSize"])(hexOrBytes);
    if (givenSize > size) {
        throw new Error(`Size overflow: ${givenSize} > ${size}`);
    }
} //# sourceMappingURL=assert-size.js.map
}}),
"[project]/node_modules/thirdweb/dist/esm/utils/encoding/helpers/charcode-to-base-16.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/utils/encoding/hex.js [app-client] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$text$2d$encoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/text-encoder.js [app-client] (ecmascript)");
// slightly tweaked re-exports from viem for the moment
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$helpers$2f$assert$2d$size$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/encoding/helpers/assert-size.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$helpers$2f$charcode$2d$to$2d$base$2d$16$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/encoding/helpers/charcode-to-base-16.js [app-client] (ecmascript)");
;
;
;
;
...
function hexToString(hex, opts = {}) {
    ...
    if (opts.size) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$helpers$2f$assert$2d$size$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertSize"])(bytes, {
            size: opts.size
        });
        bytes = trim(bytes, {
            dir: "right"
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$text$2d$decoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cachedTextDecoder"])().decode(bytes);
}
function hexToBigInt(hex, opts = {}) {
    const { signed } = opts;
    if (opts.size) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$helpers$2f$assert$2d$size$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertSize"])(hex, {
            size: opts.size
        });
    }
...
function hexToUint8Array(hex, opts = {}) {
    ...
    for(let index = 0, j = 0; index < length; index++){
        const nibbleLeft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$helpers$2f$charcode$2d$to$2d$base$2d$16$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["charCodeToBase16"])(hexString.charCodeAt(j++));
        const nibbleRight = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$helpers$2f$charcode$2d$to$2d$base$2d$16$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["charCodeToBase16"])(hexString.charCodeAt(j++));
...
function stringToHex(value_, opts = {}) {
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$text$2d$encoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cachedTextEncoder"])().encode(value_);
...
"[project]/node_modules/thirdweb/dist/esm/utils/encoding/to-bytes.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function hexToBytes(hex_, opts = {}) {
    ...
    if (opts.size) {
        ...
        hex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["padHex"])(hex, {
            dir: "right",
            size: opts.size
        });
    }
...
function numberToBytes(value, opts) {
    const hex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["numberToHex"])(value, opts);
    return hexToBytes(hex);
}
function stringToBytes(value, opts = {}) {
    const bytes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$text$2d$encoder$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cachedTextEncoder"])().encode(value);
    if (typeof opts.size === "number") {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$helpers$2f$assert$2d$size$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assertSize"])(bytes, {
            size: opts.size
        });
...
function createThirdwebClient(options) {
    ...
    if (secretKey) {
        return {
            ...rest,
            clientId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$client$2d$id$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeClientIdFromSecretKey"])(secretKey),
            secretKey
        };
    }
...
"[project]/node_modules/thirdweb/dist/esm/utils/domains.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/version.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/utils/detect-platform.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/utils/fetch.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$version$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/version.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$caching$2f$lru$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/caching/lru.js [app-client] (ecmascript)");
...
const IS_THIRDWEB_URL_CACHE = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$caching$2f$lru$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LruMap"](4096);
...
function getPlatformHeaders() {
    ...
    let os = null;
    if (typeof navigator !== "undefined") {
        os = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$detect$2d$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["detectOS"])(navigator.userAgent);
    }
    ...
    previousPlatform = Object.entries({
        "x-sdk-platform": (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$detect$2d$platform$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["detectPlatform"])(),
        "x-sdk-version": __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$version$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["version"],
...
"[project]/node_modules/thirdweb/dist/esm/utils/promise/withCache.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/chains/utils.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function getRpcUrlForChain(options) {
    const baseRpcUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().rpc;
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isThirdwebUrl"])(rpc)) {
        const rpcUrl = new URL(options.chain.rpc.replace(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_RPC_URL"], baseRpcUrl));
...
"[project]/node_modules/thirdweb/dist/esm/contract/contract.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/utils/hashing/keccak256.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/utils/address.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const IS_ADDRESS_CACHE = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$caching$2f$lru$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LruMap"](4096);
...
function encodeAddress(value) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$address$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAddress"])(value)) {
...
"[project]/node_modules/thirdweb/dist/esm/utils/json.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/rpc/actions/eth_getCode.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/rpc/fetch-rpc.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function fetchRpc(rpcUrl, client, options) {
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientFetch"])(client)(rpcUrl, {
        headers: {
            ...client.config?.rpc?.fetch?.headers,
            "Content-Type": "application/json"
        },
        body: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$json$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringify"])(options.requests),
        method: "POST",
...
async function fetchSingleRpc(rpcUrl, client, options) {
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientFetch"])(client)(rpcUrl, {
        ...
        body: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$json$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringify"])(options.request),
        method: "POST",
        requestTimeoutMs: options.requestTimeoutMs ?? client.config?.rpc?.fetch?.requestTimeoutMs,
        keepalive: client.config?.rpc?.fetch?.keepalive
    });
...
"[project]/node_modules/thirdweb/dist/esm/rpc/rpc.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$rpc$2f$fetch$2d$rpc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/rpc/fetch-rpc.js [app-client] (ecmascript)");
;
;
...
function getRpcClient(options) {
    ...
    const rpcClient = (()=>{
        ...
        const rpcUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$chains$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRpcUrlForChain"])({
         ...
         */ function sendPendingBatch() {
            ...
            pendingBatch = [];
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$rpc$2f$fetch$2d$rpc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchRpc"])(rpcUrl, options.client, {
                requests,
        ...
        if (batchSize === 1) {
            return async (request)=>{
                ...
                // biome-ignore lint/suspicious/noExplicitAny: TODO: fix any
                request.jsonrpc = "2.0";
                const rpcResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$rpc$2f$fetch$2d$rpc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchSingleRpc"])(rpcUrl, options.client, {
                    request: request,
                    requestTimeoutMs: options.config?.requestTimeoutMs
                });
                if (!rpcResponse) {
...
"[project]/node_modules/thirdweb/dist/esm/contract/actions/get-bytecode.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$rpc$2f$actions$2f$eth_getCode$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/rpc/actions/eth_getCode.js [app-client] (ecmascript)");
...
function getBytecode(contract) {
    ...
    const prom = (async ()=>{
        const rpcRequest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$rpc$2f$rpc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRpcClient"])(contract);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$rpc$2f$actions$2f$eth_getCode$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["eth_getCode"])(rpcRequest, {
...
async function detectMethod(options) {
    const bytecode = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$contract$2f$actions$2f$get$2d$bytecode$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBytecode"])(options.contract);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/domains.js [app-client] (ecmascript)");
;
const getPayBuyWithCryptoStatusUrl = ()=>`https://${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().pay}/buy-with-crypto/status/v1`;
const getPayBuyWithCryptoQuoteEndpoint = ()=>`https://${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().pay}/buy-with-crypto/quote/v1`;
const getPayBuyWithFiatQuoteEndpoint = ()=>`https://${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().pay}/buy-with-fiat/quote/v1`;
const getPayBuyWithFiatStatusEndpoint = ()=>`https://${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().pay}/buy-with-fiat/status/v1`;
const getPayBuyWithFiatHistoryEndpoint = ()=>`https://${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().pay}/buy-with-fiat/history/v1`;
const getPayBuyWithCryptoHistoryEndpoint = ()=>`https://${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().pay}/buy-with-crypto/history/v1`;
const getPaySupportedDestinations = ()=>`https://${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().pay}/destination-tokens/v1`;
const getPaySupportedSources = ()=>`https://${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().pay}/buy-with-crypto/source-tokens/v1`;
const getPayBuyHistoryEndpoint = ()=>`https://${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().pay}/wallet/history/v1`; //# sourceMappingURL=definitions.js.map
}}),
...
async function getBuyWithCryptoQuote(params) {
    try {
        ...
        const url = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$utils$2f$definitions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPayBuyWithCryptoQuoteEndpoint"])()}?${queryString}`;
        ...
        const swapRoute = {
            ...
            approval: data.approval ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$extensions$2f$erc20$2f$write$2f$approve$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["approve"])({
                contract: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$contract$2f$contract$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getContract"])({
                    ...
                    chain: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$chains$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCachedChain"])(data.approval.chainId)
                }),
...
"[project]/node_modules/thirdweb/dist/esm/pay/buyWithCrypto/getHistory.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getBuyWithCryptoHistory(params) {
    try {
        ...
        const queryString = queryParams.toString();
        const url = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$utils$2f$definitions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPayBuyWithCryptoHistoryEndpoint"])()}?${queryString}`;
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientFetch"])(params.client)(url);
        // Assuming the response directly matches the SwapResponse interface
        if (!response.ok) {
            response.body?.cancel();
...
//# sourceMappingURL=node_modules_thirdweb_dist_esm_78b2ce6f._.js.map