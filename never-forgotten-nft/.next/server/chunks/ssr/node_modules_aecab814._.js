...
"[project]/node_modules/@paperxyz/embedded-wallet-service-sdk/dist/index.mjs [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    onIframeLoadHandler(e, t, r) {
        return ()=>i(this, null, function*() {
                yield new Promise((o, n)=>i(this, null, function*() {
                        ...
                        }, `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$paperxyz$2f$sdk$2d$common$2d$utilities$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPaperOriginUrl"])()}${E}`, [
                            d.port2
                        ]);
                    }));
            });
            ...
            return r && (this.iframe.style.display = "block", yield v(.005)), new Promise((d, l)=>{
                ...
                if (a.isInjectRecoveryCode) {
                    let c = (g)=>i(this, null, function*() {
                            var U, b;
                            if (g.origin !== (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$paperxyz$2f$sdk$2d$common$2d$utilities$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPaperOriginUrl"])() || g.data.type !== "paper_getRecoveryCode" || typeof g.data.userWalletId != "string") return;
                            ...
                            (b = this.iframe.contentWindow) == null || b.postMessage({
                                ...
                                recoveryCode: V
                            }, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$paperxyz$2f$sdk$2d$common$2d$utilities$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPaperOriginUrl"])()), window.removeEventListener("message", c);
                        });
...
function re({ clientId: s, path: e, queryParams: t }) {
    var a;
    let r = new URL(e, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$paperxyz$2f$sdk$2d$common$2d$utilities$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPaperOriginUrl"])());
        ...
        return i(this, null, function*() {
            ...
            let n = yield new Promise((d, l)=>{
                let p = window.setInterval(()=>i(this, null, function*() {
                        ...
                        if (c.origin === (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$paperxyz$2f$sdk$2d$common$2d$utilities$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPaperOriginUrl"])()) {
                                ...
                                case "injectDeveloperClientId":
                                    {
                                        ...
                                        }, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$paperxyz$2f$sdk$2d$common$2d$utilities$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPaperOriginUrl"])());
                                        break;
                                    }
                            }
                        }
...
;
;
var T = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$abstract$2d$signer$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Signer"] {
    constructor({ provider: t, clientId: r, querier: a }){
        var o;
        super();
        this.DEFAULT_ETHEREUM_CHAIN_ID = 5;
        this.clientId = r, this.querier = a, this.endpoint = (o = t.connection) == null ? void 0 : o.url, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$properties$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defineReadOnly"])(this, "provider", t);
    }
    getAddress() {
        return i(this, null, function*() {
...
"[project]/node_modules/@thirdweb-dev/wallets/evm/connectors/paper/dist/thirdweb-dev-wallets-evm-connectors-paper.esm.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$paperxyz$2f$embedded$2d$wallet$2d$service$2d$sdk$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@paperxyz/embedded-wallet-service-sdk/dist/index.mjs [app-ssr] (ecmascript)");
...
;
;
class PaperWalletConnector extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$connector$2d$20f7cf73$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["C"] {
    constructor(options){
        super();
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$defineProperty$2d$7303a112$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["_"])(this, "name", "Paper Wallet");
    ...
    getPaperSDK() {
        if (!this.paper) {
            this.paper = new Promise(async (resolve, reject)=>{
                ...
                try {
                    const { PaperEmbeddedWalletSdk } = await __turbopack_context__.r("[project]/node_modules/@paperxyz/embedded-wallet-service-sdk/dist/index.mjs [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
                    const methodToEnum = {
                        AWS_MANAGED: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$paperxyz$2f$embedded$2d$wallet$2d$service$2d$sdk$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RecoveryShareManagement"].AWS_MANAGED,
                        USER_MANAGED: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$paperxyz$2f$embedded$2d$wallet$2d$service$2d$sdk$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RecoveryShareManagement"].USER_MANAGED
                    };
    ...
    async connect(options) {
        ...
        switch(user.status){
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$paperxyz$2f$embedded$2d$wallet$2d$service$2d$sdk$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UserStatus"].LOGGED_OUT:
                {
                    let authResult;
                    // Show Google popup
            ...
            case __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$paperxyz$2f$embedded$2d$wallet$2d$service$2d$sdk$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UserStatus"].LOGGED_IN_WALLET_INITIALIZED:
                {
...
//# sourceMappingURL=node_modules_aecab814._.js.map