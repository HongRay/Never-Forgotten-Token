...
"[project]/node_modules/@thirdweb-dev/sdk/dist/Vote-f939a040.esm.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@thirdweb-dev/sdk/dist/vote-a6a06847.esm.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$Vote$2d$f939a040$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@thirdweb-dev/sdk/dist/Vote-f939a040.esm.js [app-ssr] (ecmascript)");
...
class Vote {
   ...
   */ async get(proposalId) {
        ...
        const proposals = all.filter((p)=>p.proposalId.eq(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$bignumber$2f$lib$2e$esm$2f$bignumber$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].from(proposalId)));
   ...
   */ async getAll() {
        ...
        const _items = await Promise.all(_proposals.map((item)=>Promise.all([
                this.contractWrapper.read("state", [
                    item.proposalId
                ]),
   ...
   */ async getProposalVotes(proposalId) {
        ...
        return [
            {
                type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$Vote$2d$f939a040$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["V"].Against,
                label: "Against",
                count: votes.againstVotes
            },
            {
                type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$Vote$2d$f939a040$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["V"].For,
                label: "For",
                count: votes.forVotes
            },
            {
                type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$Vote$2d$f939a040$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["V"].Abstain,
                label: "Abstain",
   ...
   */ async canExecute(proposalId) {
        ...
        const descriptionHash = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__utils$3e$__["utils"].id(proposal.description);
        try {
   ...
   */ async balance() {
        ...
        return {
            ...
            decimals: 18,
            value: balance,
            displayValue: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__utils$3e$__["utils"].formatUnits(balance, 18)
        };
    }
    /**
   ...
   */ async balanceOfToken(tokenAddress) {
        ...
        const erc20 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$contracts$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Contract"](await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$index$2d$6d283666$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["aQ"])(tokenAddress), ERC20Abi, this.contractWrapper.getProvider());
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$fetchCurrencyValue$2d$473fae98$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"])(this.contractWrapper.getProvider(), tokenAddress, await erc20.balanceOf(this.contractWrapper.address));
    }
    /**
   ...
   */ async ensureExists(proposalId) {
        try {
            await this.contractWrapper.read("state", [
                proposalId
            ]);
        } catch (e) {
   ...
   */ async settings() {
        const [votingDelay, votingPeriod, votingTokenAddress, votingQuorumFraction, proposalTokenThreshold] = await Promise.all([
            ...
            this.contractWrapper.read("quorumNumerator", []),
            this.contractWrapper.read("proposalThreshold", [])
        ]);
        const votingTokenMetadata = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$fetchCurrencyValue$2d$473fae98$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["f"])(this.contractWrapper.getProvider(), votingTokenAddress);
        return {
   ...
   */ propose = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$transactions$2d$89262635$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(async (description, executions)=>{
        if (!executions) {
            executions = [
                {
   ...
   */ vote = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$transactions$2d$89262635$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])((()=>{
        var _this = this;
   ...
   */ execute = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$sdk$2f$dist$2f$transactions$2d$89262635$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"])(async (proposalId)=>{
        await this.ensureExists(proposalId);
        const proposal = await this.get(proposalId);
        const tos = proposal.executions.map((p)=>p.toAddress);
        const values = proposal.executions.map((p)=>p.nativeTokenValue);
...
//# sourceMappingURL=node_modules_%40thirdweb-dev_sdk_dist_0f653880._.js.map