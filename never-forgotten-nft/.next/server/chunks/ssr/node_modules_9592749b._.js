...
"[project]/node_modules/@blocto/sdk/dist/blocto-sdk.module.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
/* eth series constants end */ /* aptos constants begin */ const APT_SESSION_KEY_MAPPING = {
    1: KEY_SESSION.prod,
    2: KEY_SESSION.dev,
    3: KEY_SESSION.dev,
    4: KEY_SESSION.dev,
...
class EthereumProvider extends BloctoProvider {
            ...
            function processResponses(payload, responses) {
                ...
                payload.forEach((item)=>{
                    ...
                    if (item.method === 'eth_sendTransaction') {
                        ...
                        baseResponse.error = responses[0].status !== 'fulfilled' ? responses[0].reason : undefined;
                    } else {
                        if (responseIndex < responses.length) {
                            baseResponse.result = responses[responseIndex].value;
                            baseResponse.error = responses[responseIndex].status !== 'fulfilled' ? responses[responseIndex].reason : undefined;
                            responseIndex++;
                        }
                    }
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            if ((_a = this.existedSDK) === null || _a === void 0 ? void 0 : _a.isBlocto) {
                if (this.existedSDK.chainId !== this.chainId) {
                    ...
                    setEvmAddress(sessionKeyEnv, blockchainName, [
                        this.existedSDK.address
                    ]);
                }
                    ...
                    if (e.origin === walletServer) {
                        if (e.data.type === 'ETH:FRAME:RESPONSE') {
                            ...
                            addSelfRemovableHandler('message', (event, removeListener)=>{
                                ...
                                if (isAccountChanged) {
                                    (_c = this.eventListeners) === null || _c === void 0 ? void 0 : _c.accountsChanged.forEach((listener)=>listener([
                                            e.data.addr
                                        ]));
                                }
                        ...
                        if (e.data.type === 'ETH:FRAME:RESPONSE') {
                            ...
                            if (((_a = e.data) === null || _a === void 0 ? void 0 : _a.addr) && oldAccount) {
                                setAccountStorage(sessionKeyEnv, {
                                    ...
                                    evm: {
                                        [switchableNetwork[newChainId].name]: [
                                            e.data.addr
                                        ]
                                    }
                                }, (_c = e.data) === null || _c === void 0 ? void 0 : _c.exp);
                                if (e.data.addr !== oldAccount) {
                                    (_d = this.eventListeners) === null || _d === void 0 ? void 0 : _d.accountsChanged.forEach((listener)=>listener([
                                            e.data.addr
                                        ]));
                                }
                            }
    ...
    handleDisconnect() {
        ...
        return __awaiter(this, void 0, void 0, function*() {
            if ((_a = this.existedSDK) === null || _a === void 0 ? void 0 : _a.isBlocto) {
                return this.existedSDK.request({
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            if (networkList === null || networkList === void 0 ? void 0 : networkList.length) {
                const listToAdd = networkList.map(({ chainId, rpcUrls })=>{
                    ...
                    if (!parsedRpc) throw dist.ethErrors.rpc.invalidParams('rpcUrls required');
    ...
    on(event, listener) {
        var _a;
        if ((_a = this.existedSDK) === null || _a === void 0 ? void 0 : _a.isBlocto) this.existedSDK.on(event, listener);
        super.on(event, listener);
    }
    removeListener(event, listener) {
        var _a;
        if ((_a = this.existedSDK) === null || _a === void 0 ? void 0 : _a.isBlocto) this.existedSDK.off(event, listener);
...
_EthereumProvider_instances = new WeakSet(), _EthereumProvider_getBloctoProperties = function _EthereumProvider_getBloctoProperties() {
    ...
    return __awaiter(this, void 0, void 0, function*() {
        ...
        if (!chain_id) throw dist.ethErrors.provider.unsupportedMethod(`Get support chain failed: ${chainId} might not be supported yet.`);
                        ...
                        if (e.origin === this.server) {
                            if (e.data.type === 'APTOS:FRAME:RESPONSE') {
                                ...
                                addSelfRemovableHandler('message', (event, removeListener)=>{
                                    var _a, _b;
                                    const messageEvent = event;
                                    if (((_a = messageEvent.data) === null || _a === void 0 ? void 0 : _a.type) === 'BLOCTO_SDK:ACCOUNT_CHANGED' && ((_b = messageEvent.data) === null || _b === void 0 ? void 0 : _b.originChain) !== CHAIN.APTOS) {
                                        this.disconnect();
                                        removeListener();
                                    }
                                });
...
"[project]/node_modules/@thirdweb-dev/wallets/evm/connectors/blocto/dist/thirdweb-dev-wallets-evm-connectors-blocto.esm.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$blocto$2f$sdk$2f$dist$2f$blocto$2d$sdk$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@blocto/sdk/dist/blocto-sdk.module.js [app-ssr] (ecmascript)");
...
;
;
class BloctoConnector extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$WagmiConnector$2d$6011bbb1$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["W"] {
    constructor(_ref){
    ...
    async connect(config) {
        try {
            ...
            const account = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__utils$3e$__["utils"].getAddress(accounts[0]);
    ...
    getProvider() {
        ...
        if (!this._provider) {
            ...
            this._provider = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$blocto$2f$sdk$2f$dist$2f$blocto$2d$sdk$2e$module$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]({
                ethereum: {
                    chainId: _chainId,
                    rpc: _rpc
                },
    ...
    async switchChain(chainId) {
        const provider = await this.getProvider();
        const id = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__utils$3e$__["utils"].hexValue(chainId);
        const chain = this.chains.find((x)=>x.chainId === chainId);
        if (!chain) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$errors$2d$35fc3528$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["S"](new Error("chain not found on connector."));
        }
        ...
        if (!isBloctoSupportChain) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$errors$2d$35fc3528$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["S"](new Error(`Blocto unsupported chain: ${id}`));
        }
        try {
            await provider.request({
                method: "wallet_addEthereumChain",
                params: [
                    {
                        chainId: id,
                        rpcUrls: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$url$2d$0d129c6b$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["g"])(chain) // no client id on purpose here
                    }
                ]
            });
            await provider.request({
    ...
    async onChainChanged(chain) {
        const id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$thirdweb$2d$dev$2f$wallets$2f$dist$2f$normalizeChainId$2d$abcb61d5$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])(chain);
        const unsupported = this.isChainUnsupported(id);
...
//# sourceMappingURL=node_modules_9592749b._.js.map